  ...
  return (
    <>
      ...
      <List
        ...
        className="w-full divide-y divide-gray-200 bg-white rounded-lg"
      >
        {stores.map((store) => (
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="ml-4 flex-1 min-w-0">
                <p className="text-lg font-semibold">
                  <Link to={`${ROUTER_PATH.salon}${store.storeNo}`}>
                    {store.storeName}
                  </Link>
                </p>
                <div className="text-sm mt-1 text-gray-600 truncate">
                  ...
                  <span className="mt-2 text-[14px] font-semibold block whitespace-normal">
